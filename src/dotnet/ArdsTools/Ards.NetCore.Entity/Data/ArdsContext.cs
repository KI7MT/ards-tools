...
// Copyright   : GPLv3
// Description : DB Contest for ARDS Schema
//-----------------------------------------------------------------------------
...
namespace Ards.NetCore.Entity.Models
{
    public partial class ArdsContext : DbContext
    {
        ...
        public virtual DbSet<EqslAg> EqslAg { get; set; }
        ...
        public virtual DbSet<PubaccAm> PubaccAm { get; set; }
        public virtual DbSet<PubaccEn> PubaccEn { get; set; }
        public virtual DbSet<PubaccHd> PubaccHd { get; set; }
        ...
        // Unable to generate entity type for table 'fcc.pubacc_hs'. Please see the warning messages.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Host=localhost;Database=ards;Username=ards;Password=ards");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EqslAg>(entity =>
            {
                entity.Property(e => e.Id).HasDefaultValueSql("nextval('eqsl.eqsl_ag_id_seq'::regclass)");
            });
            ...
            modelBuilder.Entity<PubaccAm>(entity =>
            {
                entity.HasKey(e => e.UniqueSystemIdentifier)
                    .HasName("pubacc_am_usi_pkey");
            });

            modelBuilder.Entity<PubaccEn>(entity =>
            {
                entity.HasKey(e => e.UniqueSystemIdentifier)
                    .HasName("pubacc_en_usi_pkey");
            });

            modelBuilder.Entity<PubaccHd>(entity =>
            {
                entity.HasKey(e => e.UniqueSystemIdentifier)
                    .HasName("pubacc_hd_usi_pkey");
            });
            ...
            modelBuilder.HasSequence<int>("eqsl_ag_id_seq");
        }
    }
}
