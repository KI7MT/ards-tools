...
/**
 * The persistent class for the pas_054 database table.
 * 
 */
@Entity
@Table(name="pas_054")
@NamedQuery(name="Pas054.findAll", query="SELECT p FROM Pas054 p")
public class Pas054 implements Serializable {
