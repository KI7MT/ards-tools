...
/**
 * The persistent class for the pas_130 database table.
 * 
 */
@Entity
@Table(name="pas_130")
@NamedQuery(name="Pas130.findAll", query="SELECT p FROM Pas130 p")
public class Pas130 implements Serializable {
